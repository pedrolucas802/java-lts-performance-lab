...
# Canonical Path
Use the full runner as the primary command path. The smaller bash runners remain useful for smoke tests and targeted reruns.
...
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_startup_benchmark.sh 21 3
...
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 products 10s 10
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 products-db 10s 10
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 transform 10s 10
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 aggregate-platform 10s 10
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 aggregate-virtual 10s 10
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_http_benchmark.sh 21 mixed-workload 10s 10

# 5. Run memory scenarios directly
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_memory_benchmark.sh 21 products
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_memory_benchmark.sh 21 products-db
BENCHMARK_PROFILE=stock bash scripts/runners/run_quarkus_memory_benchmark.sh 21 transform
